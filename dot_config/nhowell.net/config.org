...
function fish_user_key_bindings
    if test "$fish_key_bindings" = fish_vi_key_bindings
        ...
        bind --user -M default n 'fish_vi_run_count up-or-search'
        bind --user -M default t 'fish_vi_run_count down-or-search'

        bind --user -M operator s 'fish_vi_exec_motion forward-char'
        bind --user -M operator n 'fish_vi_exec_motion up-line'
        bind --user -M operator t 'fish_vi_exec_motion down-line'
