...
set-window-option -g window-status-format ' #F#I#[fg=#bdae93]|#[fg=#f9f5d7]#{?#{==:#{window_name},fish},#{pane_current_path},#W} '
set-window-option -g window-status-current-format ' #F#I#[fg=#bdae93]|#[fg=#3c3836]#{?#{==:#{window_name},fish},#{pane_current_path},#W} '
...
set-window-option -g -t main window-status-current-format ' #F#I#[fg=#bdae93]|#[fg=#3c3836]#{?#{==:#{window_name},fish},#{pane_current_path},#W} '
#+end_src
