...
#+begin_src sh :tangle ~/.local/bin/dconfe
#!/bin/sh
...
#+begin_src sh :tangle ~/.local/bin/dconfc
#!/bin/sh
# SPDX-License-Identifier: GPL-3.0-or-later
set -e
...
#+begin_src sh :tangle ~/.local/bin/dconf-list-recursively
#!/bin/sh
# SPDX-License-Identifier: GPL-3.0-or-later
l() {
...
function ec --description 'emacsclient'
    command emacsclient --alternate-editor="emacs" --сreate-frame $argv
end
#+end_src
