...
set-window-option -g window-status-format ' #F#I#[fg=#bdae93]|#[fg=#f9f5d7]#W '
set-window-option -g window-status-current-format ' #F#I#[fg=#bdae93]|#[fg=#3c3836]#W '
...
set-window-option -g -t main window-status-current-format ' #F#I#[fg=#bdae93]|#[fg=#3c3836]#W '
#+end_src
