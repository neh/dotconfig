...
if [[ "$current" =~ dark ]]; then
    ...
    gsettings set com.gexperts.Tilix.ProfilesList default 41f4a0a0-1054-4604-8f32-98ee11e14173
else
    gsettings set org.gnome.desktop.interface gtk-theme $GTK_THEME_DARK
    gsettings set com.gexperts.Tilix.ProfilesList default 2a800483-78d7-4509-b51c-23ff417dc81c
fi

emacsclient -e '(neh/toggle-dark-mode)'
#+end_src
